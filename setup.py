...
setup(
    ...
    version="0.2.1",
    description="a simple cli tools to generate flask project template",
    ...
    download_url="https://github.com/AlphaBeta1906/create-flask-app/archive/refs/tags/v0.2.1.tar.gz",
    entry_points="""
        [console_scripts]
